...
class ResampleLoss(nn.Module):
    ...
    def __init__(self,
        ...
        self.class_freq = np.asarray(class_freq)
        self.class_freq = torch.from_numpy(self.class_freq)
        self.class_freq = self.class_freq.float()
        self.class_freq = self.class_freq.cuda()
