...
def load_model(save_path):
    ...
    '''
    if args['modelname'] == 'roformer_v2_GLEE':
...
if __name__ == "__main__":
    ...
    parser.add_argument('-config', help="configuration file *.yml", type=str, required=False, default='/data/0WYJ/newdata_wyj/CMLTES_codes/experiment/roformer_v2_chinese_char_base_GLEE/config.yml')
